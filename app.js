const questions = [
    {
        q: "이번 2026 새내기 새로배움터를 주최하는 기구는?",
        a: ["제49대 공과대학 건설준비위원회", "제54대 총학생회 비상대책위원회", "한양대학교 총동문회", "한양대학교 입학처"],
        correct: 0
    },
    {
    ...
    },
    {
        ...
        a: ["한화리조트 제주", "대구 엑스코", "한화리조트 설악", "강릉 세인트존스"],
        correct: 2
    },
    {
        q: "한양공대만의 열정 가득한 응원전의 이름은?",
        a: ["라치오스", "하이리온", "공대판", "애국한양응원제"],
        correct: 2
    },
    {
        q: "한양대학교의 설립 정신은?",
    ...
    {
        q: "2026년도 한양대학교 공과대학 학생회는 몇 대 학생회일까요?",
    ...
    {
        q: "공과대학 새내기 새로배움터에 참가하는 학과의 총 개수는?",
        a: ["18개", "19개", "20개", "21개"],
        correct: 3
    }
];
...
const fortunes = [
    ...
    "새로배움터에서 만난 친구들과 공명하는 마음으로 평생의 인연이 됩니다🤝",
    "새로배움터의 강력한 에너지의 파장이 당신의 1학기 학점 A+을 이끌 거예요🍀",
    "공대판의 뜨거운 열기가 당신의 열정을 깨울 운명입니다✨",
    "하나된 응원 소리 속에서 당신의 존재감이 빛나게 됩니다🔥",
    "선배와 동기의 목소리에 귀 기울이세요🥰",
