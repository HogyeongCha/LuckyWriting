...
2026학년도 한양대학교 공과대학 새내기 새로배움터를 위한 공식 이벤트 레이아웃 페이지입니다. 새내기들이 공과대학의 정신과 정보를 재미있게 익힐 수 있도록 퀴즈와 행운의 글귀 뽑기 기능을 제공합니다.
...
이 프로젝트는 별도의 빌드 과정이 필요 없는 정적 웹 페이지입니다.

1. 저장소를 클론하거나 소스 코드를 다운로드합니다.
2. `index.html` 파일을 웹 브라우저(Chrome, Edge 등)로 엽니다.
3. 바로 서비스를 이용할 수 있습니다.

## 📸 스크린샷

*(인스타그램 @hyu_tech 팔로우 유도 및 공유 이벤트 안내가 포함되어 있습니다.)*

---

**제49대 공과대학 학생회 건설준비위원회**  
Powered by [@hyu_tech](https://instagram.com/hyu_tech)
